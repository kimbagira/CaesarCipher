...
public class DecryptionTest {
    ...
    public void runDecryption_startUpToWord_ArrayList() {
        ...
        assertEquals(expectedOutput, testDecryption.runDecryption("word"));
    }
    @Test
    public void runDecryption_startUpToEnteredWord_ArrayList() throws Exception {
        ...
        assertEquals(expectedOutput, testDecryption.runDecryption("anyword"));
    }
    ...
    public void runDecryption_DecrypteWord_ArrayList() {
        ...
        assertEquals(expectedOutput, testDecryption.runDecryption("Numbers"));
    }
